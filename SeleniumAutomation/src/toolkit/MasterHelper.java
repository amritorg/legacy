...
public abstract class MasterHelper {
	...
	public static void init() throws Exception {
		...
		if (m_browser.equals(SupportedBrowser.Chrome.toString())) {
			...
			throw new TestWebinarException(
	...
	public void setTimeout(TimeoutType type, long time, TimeUnit unit) {
		...
		if (getWebdriver() != null) {
			...
			throw new TestWebinarException("Webdriver is not initialized");
	...
	public void isAlertExpected(boolean alertexpect) {
		try {
			...
			if (!alertexpect) {
				throw new TestWebinarException("Unexpected Alert Found : '"
						+ alert.getText() + "'");
			}
		} catch (NoAlertPresentException e) {

			if (alertexpect) {
				throw new TestWebinarException("Expected Alert Not Found");
			}
		}
	}
	...
	public void waitAndClick(WebElement element) {
		...
		try {
			...
			throw new TestWebinarException("Explicit timeout after: "
					+ m_explicit_timeout);
		}
